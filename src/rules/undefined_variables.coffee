# https://github.com/AsaAyers/coffeelint-undefined-variables

vars = require '../global_vars.coffee'
...
module.exports = class
    ...
    lintAssign: ( { variable, value } ) ->
        ...
        if variable.base.isAssignable() and variable.properties.length is 0
    ...
    lintTry: (node) ->
        if node.errorVariable?.value?
            @newVariable({
                base: {
                    value: node.errorVariable.value
